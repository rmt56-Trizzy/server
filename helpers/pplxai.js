...
export default class PplxAi {
  static pplxRequestCities = async (chat) => {
    const options = {
      method: "POST",
      headers: {
  ...
  static pplxRequestItineraries = async (chat) => {
    const options = {
      method: "POST",
      headers: {
        accept: "application/json",
  ...
  static pplxRequestChat1 = async (chat) => {
    const options = {
      method: "POST",
      headers: {
        accept: "application/json",
  ...
  static pplxRequestChat2 = async (chat) => {
    const options = {
      method: "POST",
      headers: {
        accept: "application/json",
